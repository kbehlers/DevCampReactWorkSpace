    ...
    render() {
        return (
            <form action="" className='sign-up-form'>
                <FormTitle className='sign-up-form__title' text='New User'></FormTitle>
                ...
                <Field className='sign-up-form__unit' placeholder='Enter Unit #' component={FormInput} name='unit' type='text' title="Unit #" />
                ...
                <div class="sign-up-form__text-links">
